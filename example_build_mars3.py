...
if __name__ == "__main__":
    ...
    tbl_perturbation = burnman.BoundaryLayerPerturbation(
        ...
        temperature_change=400.0, #s changed a/c paper! cite (300-600 K)
        boundary_layer_ratio=150/400, #s changed as sluggish mantle with top-heavy thermal structure  # 0.0 means No boundary layer i.e. uniform perturbation
    )
